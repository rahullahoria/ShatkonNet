...
$otherServices = mysqli_query($dbHandle, "SELECT a.price, a.nagotiable, b.name, b.pic_id, b.description
        ...
        <nav class="navbar-default navbar-side pull-right" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  ><i class="fa fa-dashboard fa-3x"></i> 
                        <?=$serviceProviderData['organization']; ?></a>
                    </li>
                     <li>
                        <a  ><i class="fa fa-desktop fa-3x"></i>
                        <?=$serviceProviderData['description']; ?></a>
                    </li>
                    <li>
                        <a  ><i class="fa fa-qrcode fa-3x"></i>
                        ...
                        <section id="carouselSection" style="text-align:center">
                            <div id="myCarousel" class="carousel slide">
                                ...
                                <div  style="text-align:center"  class="item active">
                                    <div class="wrapper"><img src="assets/img/business_website_templates_1.jpg" alt="business webebsite template">
                                    <div class="carousel-caption">
                                    </div>
                                    </div>
                                </div>
                                <div  style="text-align:center"  class="item">
                                    <div class="wrapper"><img src="assets/img/business_website_templates_2.jpg" alt="business themes">
                                    <div class="carousel-caption">
                                    </div>
                                    </div>
                                </div>
                                <div  style="text-align:center"  class="item">
                                    <div class="wrapper"><img src="assets/img/business_website_templates_3.jpg" alt="business themes">
                                    <div class="carousel-caption">
                                    </div>
                                    </div>
                                </div>
                                <div  style="text-align:center"  class="item">
                                    <div class="wrapper"><img src="assets/img/business_website_templates_4.jpg" alt="business themes">
                                    <div class="carousel-caption">
                                    </div>
                                    </div>
                                </div>
                                <div  style="text-align:center"  class="item">
                                    <div class="wrapper"><img src="assets/img/business_website_templates_5.jpg" alt="business themes">
                                    <div class="carousel-caption">
                                    </div>
                                    </div>
                                </div>
                                </div>
                                <a class="left carousel-control" style="vertical-align:center" href="#myCarousel" data-slide="prev">&lsaquo;</a>
                                <a class="right carousel-control" style="vertical-align:center" href="#myCarousel" data-slide="next">&rsaquo;</a>
                            </div>
                        </section>
                    </div>
                </div>              
